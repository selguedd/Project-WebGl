...
const main = function (resources) {
  ...
  const groundColor = new THREE.Vector3(0.160, 0.160, 0.160);
  ...
  const texture_city_building = (new THREE.TextureLoader()).load( "img/city_building_night.jpg" )
  const texture_city_building_2 = (new THREE.TextureLoader()).load( "img/city_building_night2.jpg" )
  const texture_city_house = (new THREE.TextureLoader()).load( "img/city_house_night_1.jpg" )
  const texture_car_light = (new THREE.TextureLoader()).load( "img/light.png" )
  const texture_city_house_2 = (new THREE.TextureLoader()).load( "img/city_house_night_2.jpg" )
  const texture_city_house_3 = (new THREE.TextureLoader()).load( "img/city_house_night_3.jpg" )
  const texture_city_house_4 = (new THREE.TextureLoader()).load( "img/city_house_night_2.jpg" )
  // Three.js init
  ...
  function fillCellWithRandomBlocks(cell) {
    ...
    if (cell.position['x'] < 4000 && cell.position['x'] > 2000 && cell.position['z'] > -4000 && cell.position['z'] < -2000){
      ...
      const dimX1 = innerSize;
  
      const dimY1 = innerSize;
